...
| [MalwareBazaar Community API](https://bazaar.abuse.ch/api/) | Android malware SHA-256 metadata | Metadata/hash query only; sample download endpoints are not used. |
