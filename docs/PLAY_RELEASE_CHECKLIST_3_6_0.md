# AmanSecurity 3.6.0 — Google Play release checklist

**Prepared:** 15 August 2026  
**Package:** `com.aman.security`  
**Version:** 3.6.0 / versionCode 40
...
|---|---|---|
| Application identity | Package and version are configured as `com.aman.security`, 3.6.0, versionCode 40 | Verify the package matches the existing Play listing before upload |
...
|---|---|---|
| Files and documents | File names, paths, hashes, and bounded content may be read during user-started scans | Processed locally; not uploaded in the intended 3.6.0 behavior |
| App activity | Installed-app metadata and optional local Usage Access indicators | Processed locally; not uploaded in the intended 3.6.0 behavior |
...
No declaration is expected for SMS or Call Log because the 3.6.0 build does not request those permissions. The message scanner receives content only through explicit paste/share actions.
