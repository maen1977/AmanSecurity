...
- `AmanSecurity-3.1.0-Debug-APK` — installable test APK.
- `AmanSecurity-3.1.0-Unsigned-Release-AAB` — release bundle that still requires normal Android release signing/distribution configuration.
- `AmanSecurity-3.1.0-Verification-Reports` — unit/lint/dependency reports and artifact SHA-256 checksums when available.
