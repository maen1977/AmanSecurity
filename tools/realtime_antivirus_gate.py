...
need('PeriodicWorkRequestBuilder<DownloadProtectionWorker>(2, TimeUnit.HOURS' in scheduler,'downloads_catchup')
need('LocalScanCacheStore' in downloads and 'FileScanner' in downloads and 'cached SHA-256' in downloads,'downloads_local_scan')
