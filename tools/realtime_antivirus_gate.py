...
need('ServiceCompat.startForeground' in service and 'setOngoing(true)' in (ROOT/'app/src/main/java/com/aman/security/protection/ProtectionNotifier.kt').read_text(),'persistent_status')
...
print('REALTIME_ANTIVIRUS_GATE_OK fgs=1 persistent_status=1 boot_restore=1 package_monitor=1 downloads_realtime=1 downloads_catchup=1 full_scan=1 all_files_antivirus_disclosure=1')
