...
def main():
    ...
    print('QUALITY_GATE_OK version=3.5.5 cloud_intelligence_factory=1 signed_cloud_updates=1 phone_raw_feeds=0 threat_update_actions=0 auto_build_push_main=1 manual_build=1 source_health=1 production_validation_infra=1 self_integrity=1 realtime_antivirus=1 downloads_protection=1 persistent_status=1 full_scan=1')
