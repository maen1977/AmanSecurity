...
def main():
    ...
    print('QUALITY_GATE_OK version=2.7.0 autonomous_updates=1 threat_update_actions=0 auto_build_push_main=1 manual_build=1 source_health=1 production_validation_infra=1 self_integrity=1 no_api_keys=1')
