...
need('versionCode = 13' in build and 'versionName = "2.3.0"' in build,'version 2.3.0/code13')
...
if errors:
    ...
    sys.exit(1)
print('REAL_ANTIVIRUS_GATE_OK version=2.3.0 deep_scan=1 post_install=1 signed_prefix_reputation=1 github_refresh_6h=1 threat_families=1 indicator_only=1')
