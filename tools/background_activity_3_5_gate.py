...
def main() -> None:
    ...
    need('versionName = "1.1.1.2"' in build and "versionCode = 75" in build, "version")
    ...
    print("BACKGROUND_ACTIVITY_GATE_OK version=1.1.1.2 manual_only=1 local_only=1 non_destructive=1 sensitive_permissions=0 notification=1")
