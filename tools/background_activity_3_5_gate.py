...
def main() -> None:
    ...
    need('versionName = "3.6.3"' in build and "versionCode = 43" in build, "version")
    ...
    print("BACKGROUND_ACTIVITY_GATE_OK version=3.6.3 manual_only=1 local_only=1 non_destructive=1 sensitive_permissions=0 notification=1")
