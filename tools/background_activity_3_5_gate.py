...
def main() -> None:
    ...
    need('versionName = "9.0.7"' in build and "versionCode = 65" in build, "version")
    ...
    print("BACKGROUND_ACTIVITY_GATE_OK version=9.0.7 manual_only=1 local_only=1 non_destructive=1 sensitive_permissions=0 notification=1")
