...
def main() -> None:
    ...
    need('versionName = "5.0.0"' in build and "versionCode = 54" in build, "version")
    ...
    print("BACKGROUND_ACTIVITY_GATE_OK version=5.0.0 manual_only=1 local_only=1 non_destructive=1 sensitive_permissions=0 notification=1")
