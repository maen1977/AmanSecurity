...
print('WEB_REPUTATION_3_5_OK openphish_cloud=1 full_url_hashes=1 queryless_match=1 browser_handoff_no_prequery=1 google_test_hardcode=0 accessibility=0')
