...
need('AmanSecurity-3.5.5-DirectInstall.apk' in workflow, 'direct_install_apk_missing')
need('AmanSecurity-3.5.5-DirectInstall-APK' in workflow, 'direct_install_artifact_missing')
