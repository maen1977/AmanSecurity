...
need('AmanSecurity-3.5.3-DirectInstall.apk' in workflow, 'direct_install_apk_missing')
need('AmanSecurity-3.5.3-DirectInstall-APK' in workflow, 'direct_install_artifact_missing')
