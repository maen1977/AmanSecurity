...
need('MaenShield-3.6.5-TestRelease.apk' in workflow, 'direct_install_apk_missing')
need('MaenShield-3.6.5-TestRelease-APK' in workflow, 'direct_install_artifact_missing')
