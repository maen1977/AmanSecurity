...
need('MaenShield-9.0.2-TestRelease.apk' in workflow, 'direct_install_apk_missing')
need('MaenShield-9.0.2-TestRelease-APK' in workflow, 'direct_install_artifact_missing')
