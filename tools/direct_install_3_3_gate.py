...
need('MaenShield-6.0.0-TestRelease.apk' in workflow, 'direct_install_apk_missing')
need('MaenShield-6.0.0-TestRelease-APK' in workflow, 'direct_install_artifact_missing')
