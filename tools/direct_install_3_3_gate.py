...
need('MaenShield-3.6.2-DirectInstall.apk' in workflow, 'direct_install_apk_missing')
need('MaenShield-3.6.2-DirectInstall-APK' in workflow, 'direct_install_artifact_missing')
