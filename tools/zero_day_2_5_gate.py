...
need('versionCode = 17' in build and 'versionName = "2.7.0"' in build,'version 2.7.0/code17')
...
print('ZERO_DAY_2_5_GATE_OK retained_in_2_7=1 hidden_payloads=1 anti_analysis=1 evidence_domains=1 rules>=36')
