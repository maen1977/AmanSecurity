...
need('versionCode = 20' in build and 'versionName = "3.0.0"' in build,'version 3.0.0/code20')
...
print('ZERO_DAY_2_5_GATE_OK retained_in_3_0=1 hidden_payloads=1 anti_analysis=1 evidence_domains=1 rules>=36')
