...
need('versionCode = 16' in build and 'versionName = "2.6.0"' in build,'version 2.6.0/code16')
...
print('ZERO_DAY_2_5_GATE_OK retained_in_2_6=1 hidden_payloads=1 anti_analysis=1 evidence_domains=1 rules>=36')
