...
need('versionCode = 19' in build and 'versionName = "2.9.0"' in build,'version 2.9.0/code19')
...
print('ZERO_DAY_2_5_GATE_OK retained_in_2_8=1 hidden_payloads=1 anti_analysis=1 evidence_domains=1 rules>=36')
