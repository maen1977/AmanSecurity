...
checks={
 'version_4_0':'versionName = "9.0.5"' in gradle and 'versionCode = 63' in gradle,
 ...
 'reports':'MaenShield-9.0.5-Verification-Reports' in workflow,
}
failed=[k for k,v in checks.items() if not v]
if failed: raise SystemExit(f'RELEASE_HARDENING_GATE_FAILED {failed}')
print('RELEASE_HARDENING_GATE_OK version=9.0.5 r8=1 shrink=1 backup=0 cleartext=0 cert_pin_configurable=1 auto_build=1 scheduled_build=0 artifact_checksums=1')
