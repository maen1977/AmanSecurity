...
checks={
 'version_3_3':'versionName = "3.3.0"' in gradle and 'versionCode = 23' in gradle,
 ...
 'reports':'AmanSecurity-3.3.0-Verification-Reports' in workflow,
}
failed=[k for k,v in checks.items() if not v]
if failed: raise SystemExit(f'RELEASE_HARDENING_GATE_FAILED {failed}')
print('RELEASE_HARDENING_GATE_OK version=3.3.0 r8=1 shrink=1 backup=0 cleartext=0 cert_pin_configurable=1 auto_build=1 scheduled_build=0 artifact_checksums=1')
