...
def need(ok,label):
    if not ok: raise SystemExit('LIGHTWEIGHT_LOCAL_ENGINE_3_1_FAILED '+label)
...
print('LIGHTWEIGHT_LOCAL_ENGINE_3_1_OK local_cache=1 event_driven=1 threat_refresh_6h=1 cached_reputation_sweep=1 downloads_catchup_2h=1 folder_scan_6h=1 heartbeat_10m=1 spyware_audit=1 no_cloud_backend=1')
