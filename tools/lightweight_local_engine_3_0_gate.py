...
print('LIGHTWEIGHT_LOCAL_ENGINE_3_2_OK local_cache=1 event_driven=1 cloud_threat_refresh_12h=1 cached_reputation_sweep=1 downloads_catchup_2h=1 folder_scan_6h=1 heartbeat_10m=1 spyware_audit=1 compact_cloud_consumer=1')
