...
need(sum(1 for r in det if r.startswith('RULE|')) >= 29,'compound behavior rules >=29')
...
if errors:
    ...
    sys.exit(1)
print('THREAT_REPUTATION_2_3_GATE_OK version=2.3.0 graph=bounded reviewed_signers=1 impersonation=stronger bloom=signed rules=29 canary=safe workflow=1')
