...
def main() -> None:
    ...
    need('versionCode = 74' in gradle and 'versionName = "1.1.1.1"' in gradle, "release_version")
    ...
    print('PLAY_RELEASE_GATE_OK version=1.1.1.1 target_api=36 sms_permissions=0 accessibility=0 docs=1 signed_aab_owner_action=1 public_privacy_url_owner_action=1')
