...
print('THREAT_UPDATE_TRANSPARENCY_3_5_OK periodic_daily_24h=1 manual_now=1 manual_not_replaced=1 single_package_progress=1 transfer_bytes=1 phases=1 last_success=1 next_check=1 stale_retry=1 package_card_refresh=1')
