...
print('THREAT_UPDATE_TRANSPARENCY_3_4_OK periodic_6h=1 manual_now=1 per_source_progress=1 transfer_bytes=1 phases=1 heartbeat=1 last_success=1 next_check=1 source_health=1 stale_retry=1 progress_throttled=1')
