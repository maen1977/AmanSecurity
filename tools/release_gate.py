...
need('versionCode = 8' in build and 'versionName = "1.0.0"' in build, "release version must be 1.0.0 / code 8")
...
print("PHASE8_RELEASE_GATE_OK target_api=36 version=1.0.0 r8=1 resource_shrink=1 cleartext=0 adaptive_icon=1")
