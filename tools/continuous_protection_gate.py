...
if errors:
    ...
    sys.exit(1)
print('CONTINUOUS_PROTECTION_GATE_OK version=2.5.0 daily_reputation_rescan=1 post_db_update_rescan=1 duplicate_alert_suppression=1 false_positive_stress=1 continuity_floor=1')
