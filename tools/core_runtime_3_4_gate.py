...
need('versionName = "3.4.0"' in gradle and 'versionCode = 24' in gradle,'version')
...
need('ThreatUpdateStateStore' in worker and '.update { source, completed, total ->' in worker,'update_progress')
