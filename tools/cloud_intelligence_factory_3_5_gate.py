...
need('git push --force https://x-access-token:${{ secrets.AMAN_THREAT_PUBLISH_TOKEN }}@github.com/maen1977/AmanSecurity-Threat-DB.git HEAD:main' in workflow,'publish_public_repo')
